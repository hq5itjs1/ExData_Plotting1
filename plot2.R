###################################
# Code for Plot 2 of project 1 of "Exploratory Data Analysis" course
# Date: 10-MAY-2015
...
plot(sampledata$Datetime,sampledata$Global_active_power, type="l", xlab="", ylab="Global Active Power (kilowatts)")
